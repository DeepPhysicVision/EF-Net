...
class FileReader:
    ...
    @staticmethod
    def get_position_ids(max_len=36):
        position_ids = {}
    ...
    @staticmethod
    def pad_aspect_index(aspect_inputs=[], max_length=8):
...
if __name__ == '__main__':
    ...
    print("==========================================")
    train_aspects = example_reader.pad_aspect_index(train_aspect_text_inputs.tolist(), max_length=8)
    test_aspects = example_reader.pad_aspect_index(test_aspect_text_inputs.tolist(), max_length=8)
    ...
    print("==========================================")
    position_ids = example_reader.get_position_ids(max_len=38)
